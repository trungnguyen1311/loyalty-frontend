...
export const HomePage = memo(() => {
  ...
  return (
    <div className="w-full flex justify-center mt-4">
      <div className="flex w-full flex-col items-center justify-center gap-[14px] rounded-[16px] bg-white100 p-3 md:p-[34px]">
        {/* Header Image */}
        <div className="h-[194px] w-full md:w-[364px] overflow-hidden rounded-[16px]">
          <img
